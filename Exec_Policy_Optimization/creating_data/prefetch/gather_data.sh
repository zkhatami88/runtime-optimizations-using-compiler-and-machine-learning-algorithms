...
FILE="../input/data_new_b.dat"
MAX_NUM_THREADS=16

cd build

#rm $FILE
echo "num_ops num_float_ops num_comp_ops deepest_loop_level num_threads num_lambda_iter t(5) t(50) t(100) t(500) t(1000) t(5000)" >> $FILE
